...
const TransactionCard = ({transaction}) => {
    const {addressFrom,addressTo,timestamp,amount,message,url,keyword} = transaction;
        ...
        >
            <div className="flex flex-col items-center w-full mt-3">
                <div className=" w-full mb-6 p-2">
                    ...
                    <div className="bg-balck p-3 px-5 w-max rounded-3xl -mt-5 shadow-2xl">
    ...
    return (
        <div className="flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions">
            <div className="flex flex-col md:p-12 py-12 px-4">
                ...
                (
                    <h3 className="text-white text-3xl text-center my-2">Connect your wallet to view transactions</h3>
                )}
